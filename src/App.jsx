...
if(!data.image_url){
  ...
  return (
    <main className='font-sans'>
      ...
      <Modal register={register} handleSubmit={handleSubmit} submit={submit} isShowForm={isShowForm} setIsShowForm={setIsShowForm} reset={reset} setIsUserIdToEdit={setIsUserIdToEdit} isUserIdToEdit={isUserIdToEdit} errors={errors}/>
